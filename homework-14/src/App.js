                            ...
                            <div className="col-sm-3">
                                <a href="industry.html"
                                   className="d-block link-industry text-white text-center text-uppercase">
                                    <i className="icon-education icon-industry"></i>Education
                                </a>
                            </div>
                            <div className="col-sm-3">
                                <a href="industry.html"
                                   className="d-block link-industry text-white text-center text-uppercase">
                                    <i className="icon-business icon-industry"></i>Business
                                </a>
                            </div>
                            <div className="col-sm-3">
                                <a href="industry.html"
                                   className="d-block link-industry text-white text-center text-uppercase">
                                    <i className="icon-technology icon-industry"></i>Technology
                                </a>
                            </div>
                            <div className="col-sm-3">
                                <a href="industry.html"
                                   className="d-block link-industry text-white text-center text-uppercase">
                                    <i className="icon-banking icon-industry"></i>Banking
                                </a>
                            </div>
                            <div className="col-sm-3">
                                <a href="industry.html"
                                   className="d-block link-industry text-white text-center text-uppercase">
                                    <i className="fa-3x icon-home icon-industry"></i>Real Estate
                                </a>
                            </div>
                            <div className="col-sm-3">
                                <a href="industry.html"
                                   className="d-block link-industry text-white text-center text-uppercase">
                                    <i className="fa fa-3x fa-volume-control-phone icon-industry"></i>Communication
                                </a>
                            </div>
                            <div className="col-sm-3">
                                <a href="industry.html"
                                   className="d-block link-industry text-white text-center text-uppercase">
                                    <i className="fa fa-3x fa-balance-scale icon-industry"></i>Law
                                </a>
                            </div>
                            <div className="col-sm-3">
                                <a href="industry.html"
                                   className="d-block link-industry text-white text-center text-uppercase">
                                    <i className="fa fa-3x fa-wrench icon-industry"></i>Construction
                                </a>
                            </div>
                        </div>
                    </section>
